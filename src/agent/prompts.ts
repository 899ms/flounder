...
- Source-ready is enough: once you have staged and pinned the authorized first-party source components and recorded a concrete real_target plan, immediately rewrite prepare_manifest.json and finish. Do not run build/check commands or keep fetching optional docs, older releases, comparison versions, or low-value dependencies unless they are required to identify the authorized source itself.
