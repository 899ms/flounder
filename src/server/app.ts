...
const ROUTES: Route[] = [
  ...
  route({
    ...
    body: {
      ...
      remap: "boolean?", quick: "boolean?", mockLlm: "boolean?", region: "string?", scope: "string?", verifyFindings: "object|array? — audit: inline suspected finding(s) to confirm-or-refute by execution",
